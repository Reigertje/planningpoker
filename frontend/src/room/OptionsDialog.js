...
const OptionsDialog = ({ open, handleClose, onChangeOptions, initialValue }) => {
  ...
  return <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title" fullWidth>
    ...
    <DialogContent>
      ...
      <Card variant="outlined">
        <CardContent>
          ...
          <TextField margin="dense" type="input" value={customOptions} onChange={e => setCustomOptions(e.target.value)} fullWidth />
